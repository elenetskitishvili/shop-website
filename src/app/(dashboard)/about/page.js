  ...
  return (
    <main className="main">
      <section className="max-w-screen-xl mx-auto pt-8 pb-6 grid grid-cols-[60fr_40fr] gap-36 items-center">
        <div>
          <h3 className="font-heading text-green-500 text-4xl">About Us</h3>
          ...
          <h3 className="font-heading text-green-500 text-4xl">Our Mission</h3>
          <p className="mt-3 mb-7 text-2xl font-medium leading-9">
          ...
          <h3 className="font-heading text-green-500 text-4xl">
            What Makes Us Unique
          </h3>
          <ul className="mt-5 mb-7 text-2xl font-medium leading-9 flex flex-col gap-3">
            <li className="flex items-center gap-3">
              <i className=" text-green-500  fas fa-box-open"></i>
              <span>Wide variety of products for every need</span>
            </li>
            <li className="flex items-center gap-3">
              <i className="text-green-500 fas fa-star"></i>
              <span>Commitment to quality and customer satisfaction</span>
            </li>
            <li className="flex items-center gap-3">
              <i className="text-green-500  fas fas fa-headset"></i>
              <span>Exceptional customer support</span>
            </li>
          </ul>

          <h3 className="font-heading text-green-500 text-4xl">Our Story</h3>
          <p className="mt-3 mb-7 text-2xl font-medium leading-9">
